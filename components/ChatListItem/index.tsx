...
const rgbToHex=(r, g, b)=> {
  ...
  const getMyChat=()=>{
     ...
     axios.post(`https://messangerapi533cdgf6c556.amaprods.com/api/users/getLastChatForMe`,{
       to:user.veroKey,
       from:global.privateKey
     }).then((res)=>{
      
     setLastMessage(res.data.message) ;
     props.dnt(moment(res.data.message.createdAt).unix())
//  console.log(res.data.message)
  ...
  useFocusEffect(
    React.useCallback(() => {
      // user.lastChat?setLastMessage(user.lastChat):console.log('wait')
